...
twitch_miner = TwitchChannelPointsMiner(
    username="xomyakov_1243",
    password="SUSLIK_1243_SUSLIK",           # If no password will be provided, the script will ask interactively
